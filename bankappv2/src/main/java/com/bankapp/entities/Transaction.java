...
public class Transaction {
	...
	public static Transaction createTransferDebit(Account sender, BigDecimal amount, String performedByUserId, String receiverAccountId) {
	    return new Transaction(null, sender, TransactionType.TRANSFER_OUT, ApprovalStatus.APPROVED, amount, LocalDateTime.now(), performedByUserId, null);
	}

	public static Transaction createTransferCredit(Account receiver, BigDecimal amount, String performedByUserId, String senderAccountId) {
	    return new Transaction(null, receiver, TransactionType.TRANSFER_IN, ApprovalStatus.APPROVED, amount, LocalDateTime.now(), performedByUserId, null);
	}
